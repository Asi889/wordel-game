<template>
  <div
    ...
    v-bind:key="letter"
    class="grid tilee justify-center items-center w-[35px] h-[45px] sm:w-12 sm:h-12 text-black bg-gray-400 rounded placeholder:text-black"
    v-bind:class="{
  ...
  <div
    class="grid justify-center items-center w-[35px] h-[45px] sm:w-12 sm:h-12  text-black bg-gray-400 rounded placeholder:text-black keyboardInput"
