<template>
  ...
  >
    <svg
      ...
      @click="openSettings"
      class="icon"
      v-bind:class="{ darkModeIcon: darkMode}"
    >
      <path
        class="grow-0"
    ...
    <h1
      class=" text-4xl inline-block grow-0"
      v-bind:class="{ darkModeText: darkMode }"
    >
      {{ title }}
    </h1>
    <h1 class="title text-4xl inline-block grow-0 pr-2">IL</h1>
    </div>
<svg
      xmlns="http://www.w3.org/2000/svg"
      height="24"
...
export default defineComponent({
  ...
  setup(props) {
    ...
    return { title, openSettings, openInfo, darkModeText, darkMode };
  },
});
</script>
