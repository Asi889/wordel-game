...
export function makeguess2(keboardDelay,computedGuess,allTheWord,success,currentRow,guess,wordoftheday,splitedWord,computedKeyBoard,currentRowIndex,guessNum,statistics,popUpValue,wiggle,gridImage,today,word) {
